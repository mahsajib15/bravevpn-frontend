      ...
      <div className="flex flex-col md:flex-row items-center justify-between gap-10 mb-20">
        ...
        <div className="max-w-md text-center md:text-left">
          ...
          <p className="text-sm text-gray-400 mb-4">
            BraveVPN is backed by over 10 years of academic research by our founders. Braves privacy stack uses cutting-edge protocols, encryption, mixnet, and threat-resistant routing.
          </p>
...
export default ResearchAndQuestion;
